function start() { // inicio da função start()
  ...
  jogo.timer = setInterval(loop, 17);
  ...
  function moveinimigo1() {
    ...
    if (posicaoX <= 0) {
      posicaoY = parseInt((Math.random() * 334) + 10);
  ...
  function moveamigo() {
    ...
    $("#amigo").css("left", posicaoX + velocidade3);
  ...
  function disparo() {
    ...
    if (podeAtirar == true) {
      ...
      var tempoDisparo = window.setInterval(executaDisparo, 17);
    } //Fecha podeAtirar
  ...
  function explosao2(inimigo2X, inimigo2Y) {
    ...
    var tempoExplosao = window.setInterval(removeExplosao2, 400);
